...
/**
 * @extends ServiceEntityRepository<UsersCars>
 *
...
class UsersCarsRepository extends ServiceEntityRepository
{
    ...
    public function add(UsersCars $entity, bool $flush = false): void
    {
    ...
    public function remove(UsersCars $entity, bool $flush = false): void
    {
